...
**How It Works**
Service provider records are standardized into a Google Sheets database
Each row represents one service provider
Checkbox-enabled columns support filtering
